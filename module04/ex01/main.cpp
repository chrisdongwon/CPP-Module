...
int main(void) {
  ...
  }
  {
    ...
    std::cout << "Original Dog idea[0]: " << originalDog.brain()->ideas(0)
              << std::endl;
    std::cout << "Copied Dog ideas[0]: " << copiedDog.brain()->ideas(0)
              << std::endl;
    std::cout << "Original Dog idea[1]: " << originalDog.brain()->ideas(1)
              << std::endl;
    std::cout << "Copied Dog ideas[1]: " << copiedDog.brain()->ideas(1)
              << std::endl;

    // Change original's brain to verify deep copy
    originalDog.brain()->set_ideas(0, "Eat food!");
    std::cout << "After change:" << std::endl;
    std::cout << "Original Dog ideas[0]: " << originalDog.brain()->ideas(0)
              << std::endl;
    std::cout << "Copied Dog ideas[0]: " << copiedDog.brain()->ideas(0)
              << std::endl;
    std::cout << "Original Dog idea[1]: " << originalDog.brain()->ideas(1)
    ...
    std::cout << "Original Cat ideas[0]: " << originalCat.brain()->ideas(0)
              << std::endl;
    std::cout << "Assigned Cat ideas[0]: " << assignedCat.brain()->ideas(0)
              << std::endl;
